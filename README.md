...
Start with the [user instructions](docs/USER_INSTRUCTIONS.md) or the fuller [user guide](docs/USER_GUIDE.md). For operators, see the [architecture](docs/architecture/README.md), complete [Windows-folder T480 runbook](docs/windows-folder-t480-runbook.md), [T480 assessment](docs/t480-assessment.md), [operations](docs/operations.md), and [output format](docs/output-format.md).
